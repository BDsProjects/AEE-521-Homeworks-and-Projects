...
%% Stabilator Movement for PID
tf = 20.0; %Original length of run
%tf = 60.0; %Testing this based on Koko's increased time limit
Ts = 0.01; % Original timestep
%Ts = .001; %Testing smaller time step -> bad
%Ts = .1; %best this far
%Ts = 1.0; % Worse
Ki = 0.0;
Kd = -.00015;
Kp = -0.000008;
NewAlt = 35300; % Change in altitude
%InputTime = 6; %s
